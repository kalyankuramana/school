		...
		<div class="tab-content">
							...
							<tr>
								...
								foreach($fields as $field)	//$field : english,spanish etc
								{
                                    ...
                                    <td valign="top">
                                        ...
                                        <form method="post" action="<?php echo base_url();?>index.php?teacher/manage_language/do_update/<?php echo $phrase_id;?>">
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                    <form method="post" action="<?php echo base_url();?>index.php?teacher/manage_language/add_phrase/" class="form-horizontal validatable">
                        <div class="padded">
			...
			<div class="tab-pane box" id="add_lang" style="padding: 5px">
                <div class="box-content">
                    <form method="post" action="<?php echo base_url();?>index.php?teacher/manage_language/add_language/" class="form-horizontal validatable">
                        <div class="padded">
                            <div class="control-group">
